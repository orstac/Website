...
<div class="body">
    <div class="container">
        ...
        <hr>
        <p>These terms and conditions outline the rules and regulations for the use of OrsTac's Website.</p> <br />
        <span style="text-transform: capitalize;"> OrsTac</span> is located at: Pittsburgh, PA, USA<br />
        <address><br />
        </address>
        ...
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By using OrsTac's website you consent to the use of cookies
            in accordance with OrsTac's privacy policy.</p>
        ...
        <h2>License</h2>
        <p>Unless otherwise stated, OrsTac and/or it's licensors own the intellectual property rights for
            all material on OrsTac. All intellectual property rights are reserved. You may view and/or print
            pages from http://orstac.com for your own personal use subject to restrictions set in these terms and
            conditions.</p>
        <p>You must not:</p>
        <ol>
            <li>Republish material from http://orstac.com</li>
            <li>Sell, rent or sub-license material from http://orstac.com</li>
            <li>Reproduce, duplicate or copy material from http://orstac.com</li>
        </ol>
        <p>Redistribute content from OrsTac (unless content is specifically made for redistribution).</p>
        ...
        <p>We will approve link requests from these organizations if we determine that: (a) the link would not
            ...
            the visibility associated with the hyperlink outweighs the absence of <?=$companyName?>; and (d) where
            the
        ...
        <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our
            ...
            you must notify us by sending an e-mail to <a href="mailto:support@orstac.com"
                title="send an email to support@orstac.com">support@orstac.com</a>.
        ...
        <p>No use of OrsTac's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
        <h2>Iframes</h2>
        ...
        <p>This Terms and conditions page was created at <a style="color:inherit;text-decoration:none;cursor:text;"
                href="https://termsandconditionstemplate.com">termsandconditionstemplate.com</a> generator. If you
            have
